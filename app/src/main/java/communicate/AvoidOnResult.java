...
*/
    ...
    public void startForResult(Intent intent, Callback callback) {
        mAvoidOnResultFragment.startActivityWithCallback(intent, callback);
    }

    public static void postData(int eventCode,Intent data)
    {
        String value = data.getStringExtra("text");
        BusProvider.getInstance().post(new BusEventData(eventCode,value));
